...
# Assuming 'autocorrect book.txt' contains a list of words for suggestions
...
def suggest():
    keyword = request.form['medicine-input'].lower()
    if keyword:
        similarities = [1 - textdistance.Jaccard(qval=len(keyword)-2).distance(v, keyword) for v in words_freq_dict.keys()]
